                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: CustomScrollView(
                      slivers: <Widget>[_TimelineSteps( _steps)],
                    ),
                  ),
        ...
        (BuildContext context, int index) {
          ...
          return TimelineTile(
            ...
            indicatorStyle: IndicatorStyle(
              ...
              indicator: _TimelineStepIndicator(step.step),
            ),
...
class _TimelineStepIndicator extends StatelessWidget {
  ...
  _TimelineStepIndicator(this.step);
