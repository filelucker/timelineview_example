...
// // import 'package:test_timeline_viw/apps/showcase_timeline.dart';
// import 'package:test_timeline_viw/src/showcase_timeline.dart';
// import 'package:test_timeline_viw/src2/examples.dart';
//
...
import 'package:test_timeline_viw/src2/apps/showcase_timeline.dart';
import 'package:test_timeline_viw/src2/apps/success_timeline.dart';
import 'package:test_timeline_viw/src2/apps/weather_timeline.dart';
import 'package:test_timeline_viw/src2/examples.dart';
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        body: ShowCaseWidget(
          ...
          blurValue: 1,
          // builder: Builder(builder: (context) =>  ShowcaseWeatherTimeline()),
          builder: Builder(builder: (context) =>  Examples()),
